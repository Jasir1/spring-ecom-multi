...
public class CartResource {
    ...
    @DeleteMapping("/delete/product-id/{product-id}")
    public ResponseEntity<ApplicationResponseDTO> deleteProductFromCartByProductId(@PathVariable("product-id") Long id) {
        return ResponseEntity.ok(cartService.deleteProductFromCartByProductId(id));
    }
}
