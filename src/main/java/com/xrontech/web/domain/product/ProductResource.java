...
public class ProductResource {
    ...
    @GetMapping("/get/category-id/{category-id}/{product-id}")
    public ResponseEntity<List<Product>> getProductsByCategoryIdNotSelected(@PathVariable("category-id") Long categoryId,@PathVariable("product-id") Long productId) {
        return ResponseEntity.ok(productService.getProductsByCategoryIdNotSelected(categoryId,productId));
    }
    ...
    public ResponseEntity<Product> getOwnLastAddedProductId() {
        return ResponseEntity.ok(productService.getOwnLastAddedProductId());
    }
