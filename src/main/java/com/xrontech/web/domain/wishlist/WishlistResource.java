...
public class WishlistResource {
    ...
    public ResponseEntity<ApplicationResponseDTO> deleteProductFromWishlistByProductId(@PathVariable("id") Long id) {
        return ResponseEntity.ok(wishlistService.deleteProductFromWishlistByProductId(id));
    }
}
